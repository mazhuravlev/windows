import { ISectorTexture, ISideSize, TextureType, WindowType } from '../interface';
...
export const getOffsetInWindowAxes = (sectorTexture: ISectorTexture, side: ISideSize, window: IWindowParams): Partial<ISectorTexture> => {
  const { VOffset, HOffset } = sectorTexture;
  switch (sectorTexture.sectorId) {
    case 1: {
